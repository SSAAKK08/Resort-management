...
// import photo from "../../assets/DetailRoom/Room.jpg";
...
//     <div className="mx-16">
//         <Navbar/>
//         <div className="grid grid-cols-12 gap-5 mt-36 ">
//             <div className="col-span-7 ">
//                 <img className="h-full rounded-2xl mb-10" src={photo} alt="" />
...
//             <div className="col-span-7">
//                 <h3 className="text-4xl mb-5 mt-10">Ocean Azure suite</h3>
...
//                     <hr className="mt-7 mr-8"/>

//                     <p className="text-lg mr-5 mt-8">Experience the ultimate coastal sanctuary. The Ocean Azure Suite is designed for those who appreciate the finer details of 
//                         island living. Wake up to panoramic views of the turquoise lagoon, enjoy a morning dip in your private infinity plunge pool,
//                         and let our dedicated butler service handle every detail of your stay.                    
//                     </p>

//                     <h3 className="text-2xl mt-4 text-primary-Blue">Premium Amenities</h3>

//                     <div className="grid grid-cols-12 place-items-center mt-6">
//                         <div className="col-span-6 ">
//                             <div className="flex items-center ">
//                                 <MdOutlineCropSquare/>
//                                 <h4 className="text-lg ">24/7 Dedicated Butler Service</h4>

//                             </div>

//                             <div className="flex items-center ">
//                                 <MdOutlineCropSquare/>
//                                 <h4>Private Terrace with Daybeds</h4>
...
//                             <div className="flex items-center ">
//                                 <MdOutlineCropSquare/>
//                                 <h4>Walk-in Rain Shower & Tub</h4>

//                             </div>

//                             <div className="flex items-center ">
//                                 <MdOutlineCropSquare/>
//                                 <h4>Premium Espresso Machine</h4>
...
//             {/* right hand */}
//                 <div className="col-span-5 mt-10  w-80  mx-auto border px-4 py-4">
                    
//                     <div className="flex justify-between ">
//                         <h4>$540 <sub>/night</sub></h4>
//                         <div className="flex items-center gap-2 ">
//                             <FaStar />
//                             <h4>4.9(100 reviews)</h4>
//                         </div>
...
//                             <label className=" px-3" htmlFor="checkIn">Check In</label>
//                             <input className="px-4 py-2 rounded-sm outline-none  w-full" type="date"  />
                
//                         </div>

//                         <div className=" mt-6 border-2 rounded-lg">

//                             <label className=" px-3" htmlFor="checkIn">Check out</label>
//                             <input className="px-4 py-2 rounded-sm w-full outline-none" type="date"  />
